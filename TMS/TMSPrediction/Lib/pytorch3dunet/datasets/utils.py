...
def _loader_classes(class_name):
    modules = [
        'Lib.pytorch3dunet.datasets.hdf5',
        'Lib.pytorch3dunet.datasets.dsb',
        'Lib.pytorch3dunet.datasets.utils'
    ]
...
def get_train_loaders(config, i):
    """
    ...
    train_datasets = dataset_class.create_datasets(loaders_config, phase='train', file_id = i)
