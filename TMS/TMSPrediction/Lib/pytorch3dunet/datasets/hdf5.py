...
import Lib.pytorch3dunet.augment.transforms as transforms
from Lib.pytorch3dunet.datasets.utils import get_slice_builder, ConfigDataset, calculate_stats, sample_instances
...
class AbstractHDF5Dataset(ConfigDataset):
    ...
    @classmethod
    def create_datasets(cls, dataset_config, phase, file_id = 0):
        ...
        if phase == 'train':
            print("file_paths:", phase_config['file_paths'][0], "id:", file_id)
            file_paths = phase_config['file_paths'][0][file_id]
        elif phase == 'val':
            file_paths = phase_config['file_paths']
        elif phase == 'test':
            file_paths = [os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))))+"\\wdir\\"]
